function fish_prompt
  ...
  set -l white (set_color 6272A4)
  set -l turquoise (set_color 50FA7B)
  set -l orange (set_color FF79C6)
  set -l hotpink (set_color 50FA7B)
  set -l blue (set_color blue)
  set -l limegreen (set_color FFB86C)
  ...
  ## Line 1
  ##
  echo -n $hostcolor'╭─'$hotpink$current_user$white'@'$orange$__fish_prompt_hostname$white' '$limegreen(pwd|sed "s=$HOME=~=")$turquoise '>'
  __fish_git_prompt " (%s)"
  echo
